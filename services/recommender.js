...
` : '';
  ...
  const modeInstruction = {
    discovery: `
【스타일 발견 모드】
서로 다른 스타일의 실제 상품 3개를 아래 형식으로만 답하세요.

출력 예시 (이 형식 그대로):
스타일이 다른 몇 가지를 가져왔어요.

1. **미니멀/클린** [상품명] — [핵심 특징 10자 이내]
2. **캐주얼/스트릿** [상품명] — [핵심 특징 10자 이내]
3. **트렌디/유니크** [상품명] — [핵심 특징 10자 이내]

위 3줄 외 추가 설명 절대 금지. CHIPS는 아래 태그로.`,

    refinement: `
【취향 반영 모드】
피드백을 반영한 상품 2~3개를 아래 형식으로만 답하세요.
