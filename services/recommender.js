...
[피드백을 반영했다는 자연스러운 1문장]

1. [상품명]은/는 [왜 피드백에 맞는지 — 1문장]
2. [상품명]은/는 [이유 — 1문장]
3. [상품명]은/는 [이유 — 1문장]`,
...
[현재 상품과의 연결고리 또는 추천 방향 — 1~2문장]

1. [상품명]은/는 [코디 조합 관점에서 왜 어울리는지 — 1~2문장]
2. [상품명]은/는 [이유 — 1~2문장]
3. [상품명]은/는 [이유 — 1~2문장]`,

    after_cart: `
【장바구니 추가 후 모드 — Cross-sell】
고객이 방금 상품을 장바구니에 담았습니다. 구매를 이미 결정한 상태이므로 자연스럽게 코디 완성을 도와주세요.

아래 형식으로 출력할 것.

담으셨군요! 이 상품과 함께 코디하면 좋은 아이템도 가져왔어요.

1. [상품명]은/는 [함께 입으면 어떤 룩이 완성되는지 — 1~2문장]
2. [상품명]은/는 [이유 — 1~2문장]`,
...
[질문한 상품의 핏 특성과 사이즈 선택 기준 — 1~2문장]

1. [상품명]은/는 [핏이 잘 맞는 이유 — 1~2문장]
2. [상품명]은/는 [이유 — 1~2문장]`,
...
[고객 니즈를 정확히 짚은 공감 문장 — 1~2문장]

1. [상품명]은/는 [왜 이 상품인지 핵심 이유 — 1~2문장]
2. [상품명]은/는 [이유 — 1~2문장]
3. [상품명]은/는 [이유 — 1~2문장]`,
  }[mode] || `【구체적 추천 모드】
아래 형식으로 출력할 것.
